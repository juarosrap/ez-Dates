...
-- INSERT INTO Usuarios (nombre,email,contrasenya,fechaNacimiento) 
-- VALUES ('Julián','Julian10@gmail.com','Julian34635','1998-08-05');
...
('Julián,Eduard','2003-09-14','Arco del triunfo',3,1,'2002-12-23','2004-03-03'),
('Lucas,Marisa','2002-04-03','Benito Villamarin',4,2,'2001-3-2','2003-06-03');
...
VALUES ('https://comidasespanolas.com/wp-content/uploads/2019/12/Receta-de-tortilla-espa%C3%B1ola-tradicional.jpg','playa','Mis amigos y yo disfrutando de un día en la playa',331,1),
('web\images\DANI.png','coche','Yo en Londres posando junto a mi coche favorito',22,1),
('web\images\persona2.jpg','playa','Mis amigos y yo disfrutando de un día en la playa',234,7),
('web\images\persona3.jpg','playa','Mis amigos y yo disfrutando de un día en el campo',324,2),
('web\images\persona1.jpg','playa','Mis amigos y yo disfrutando de un día en la uni',377,3),
('JUAN.png','playa','Mis amigos y yo disfrutando de un día en la discoteca abril',768,5),
...
INSERT INTO prefPeso(preferenciaId,MinimoPeso,MaximoPeso)
VALUES(1,45,90),
(2,34,89),
(3,34,67),
(4, 75, 105),

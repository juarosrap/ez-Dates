...
const fotosAPI_auto = {
    ...
    getById: async function(fotosId) {
        let response = await axios.get(`${BASE_URL}/fotos/${fotosId}`, requestOptions);
    ...
    update: async function(formData, fotosId) {
        let response = await axios.put(`${BASE_URL}/fotos/${fotosId}`, formData, requestOptions);
        return response.data;
    },

    /** Deletes an existing entry in 'fotos' by its primary key */
    delete: async function(fotosId) {
        let response = await axios.delete(`${BASE_URL}/fotos/${fotosId}`, requestOptions);
        return response.data;
    },
};
